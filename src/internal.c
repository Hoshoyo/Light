...
static const char module_base_str[] = 
"string struct {\n"
    "capacity : u32;\n"
    "length   : u32;\n"
    "data     : ^u8;\n"
...
static const char module_reflect_str[] = 
"array struct {\n"
"    capacity  : u64;\n"
"    length    : u64;\n"
...
Light_Ast**
load_internal_modules(Light_Parser* parser, Light_Scope* global_scope) {
    Light_Ast** ast = 0;
    ast = load_internal_module(parser, global_scope, (char*)module_base_str, sizeof(module_base_str));
    ast = load_internal_module(parser, global_scope, module_reflect_str, sizeof(module_reflect_str));
    return ast;
}