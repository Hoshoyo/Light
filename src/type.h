...
Light_Type* type_new_function(Light_Type** arguments_types, Light_Type* return_type, s32 arguments_count, bool all_args_internalized, u32 flags);
...
Light_Type* type_new_directive(Light_Ast* expr);
