...
void iri_emit_push(IR_Generator* gen, IR_Reg t, IR_Value imm, int byte_size, bool fp);
void iri_emit_pop(IR_Generator* gen, IR_Reg t, int byte_size, bool fp);
void iri_emit_ret(IR_Generator* gen, int pop_bytes);
