...
s32 square(s32 v);
typedef s32 __ret_make_proc(s32);
__ret_make_proc* make_proc();
char* __string_data_0 = ", ";
void map(s32* arr, s64 length, s64(*f)(s32), s32(*sq)(s32));
s32 __main();
...
print_str(__temp_v_0);
}
f(sq(*(s32*)(((char*)arr)+ 4 * (i))));
i = ((i)+0x1);
}
loop_0:;
