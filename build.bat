...
call cl /DLIGHTMAIN=1 /MT /nologo /Zi /I../include ../src/light_vm/lightvm.c ../src/light_vm/lightvm_parser.c ../src/light_vm/lightvm_print.c ../src/*.c ../src/utils/*.c ../src/backend/c/*.c ../src/backend/x86/*.c ../src/backend/*.c %ASSEMBLER_FILES% /Felight.exe /link kernel32.lib lvm.obj
